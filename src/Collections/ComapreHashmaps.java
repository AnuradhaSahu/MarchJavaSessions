...
public class ComapreHashmaps {
	...
	public static void main(String[] args) {
		...
		//1.On the basis of K-V-Use equals Method
		System.out.println(map1.equals(map2));
		System.out.println(map1.equals(map3));
		
		//compare hashmap for same keys: keysets() 
		System.out.println(map1.keySet().equals(map2.keySet()));//all the keys

		System.out.println(map1.keySet().equals(map3.keySet()));
		
		//find out the extra key-combine the keys from both the maps  using Hashset(stores unique values)
		...
		//1.using arraylist-duplicates not allowed
		...
		//2.using Hashset-duplicates allowed
